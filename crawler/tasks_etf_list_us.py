...
# Celery task 包裝
@app.task(name="crawler.tasks_etf_list_us.fetch_us_etf_list_task")
def fetch_us_etf_list_task(crawler_url: str = "https://tw.tradingview.com/markets/etfs/funds-usa/", region: str = "US") -> List[dict]:
    return fetch_us_etf_list(crawler_url=crawler_url, region=region)