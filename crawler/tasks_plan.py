...
# Celery task 包裝
@app.task(name="crawler.tasks_plan.plan_price_fetch_task")
def plan_price_fetch_task(
    etf_id: str,
    inception_date: Optional[str] = None,
) -> Optional[Dict[str, str]]:
    return plan_price_fetch(etf_id=etf_id, inception_date=inception_date)

@app.task(name="crawler.tasks_plan.plan_dividend_fetch_task")
def plan_dividend_fetch_task(
    etf_id: str,
    inception_date: Optional[str] = None,
) -> Optional[Dict[str, str]]:
    return plan_dividend_fetch(etf_id=etf_id, inception_date=inception_date)