...
# Celery task 包裝
@app.task(name="crawler.tasks_etf_list_tw.fetch_tw_etf_list_task")
def fetch_tw_etf_list_task(crawler_url: str = "https://tw.stock.yahoo.com/tw-etf", region: str = "TW") -> List[dict]:
    return fetch_tw_etf_list(crawler_url=crawler_url, region=region)